...
const templateCard = async (name, imageSrc, index) => {
  ...
  return `
    <div class="w-[48%] flex flex-col text-center bg-[${color}] dark:bg-[${color}] rounded-lg justify-center shadow-xl dark:shadow-md h-44" onclick="window.location.href = 'https://dylasx.github.io/pokedex-wwc/routes/detail/detail.html?pokemon=${name}'">
