                ...
                ${stats
                  ...
                  <li class="flex flex-col items-center">
                    <div class="flex flex-row mr-auto items-end mb-2">
                      ...
                      <h3 class="font-light text-md text-zinc-600 dark:text-white capitalize">${element.stat.name}</h3>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-200">
                        <div class="bg-[${color}] h-2.5 rounded-full dark:bg-[${color}]" style="width: ${element.base_stat}%"></div>
                    </div>
                  </li>`
                  )
                  .join('')}
